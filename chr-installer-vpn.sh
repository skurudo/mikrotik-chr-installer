...
WG_PEER_PRIVATE_KEY=$(generate_wireguard_key)

log_info "Сгенерированы WireGuard ключи"
...
# Создание расширенного autorun с VPN настройкой
...
# VPN - SSTP СЕРВЕР
# ============================================
# Создание самоподписанного сертификата для SSTP
...
/interface wireguard peers add interface=wg0 public-key="${WG_PEER_PRIVATE_KEY}" allowed-address=${WG_PEER_IP}
...
echo "  Peer PrivKey:   $WG_PEER_PRIVATE_KEY"
echo ""
...
echo "  Peer Key:     ${WG_PEER_PRIVATE_KEY}"
echo "  Peer IP:      ${WG_PEER_IP}"
echo ""
echo -e "${GREEN}═══════════════════════════════════════════${NC}"
echo ""
